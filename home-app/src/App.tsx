...
export default function App() {
  ...
  // loading screen + (optional) session check, to match your main app feel
  useEffect(() => {
    ...
    const { data: { subscription } } = supabase.auth.onAuthStateChange((_event, session) => {
      // show the same loading animation when login/logout happens
      setLoading(true)
      setTimeout(() => {
        setUser(session?.user ?? null)
        setLoading(false)
  ...
  // --- loading screen (matches your main app style) ---
  if (loading) {
    return (
        ...
        <div className="text-center">
          <div className="mb-8">
            ...
            <img
              ...
              onError={({ currentTarget }) => { currentTarget.src = '/talent book singular icon.png' }}
              alt="TalentBook Logo"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900">
      ...
      {/* Pricing (config matches your main app) */}
      ...
      <SignupModal
        ...
        // This modal may expose onContinueSignup in main; in Home we just let auth happen
      />
      <LoginModal
